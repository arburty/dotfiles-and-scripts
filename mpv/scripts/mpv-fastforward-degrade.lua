--# From https://github.com/zsugabubus/mpv-fastforward
--[[ fastforward.lua
...
local function speed_up()
  ...
  if timer == nil then
    ...
    mp.add_key_binding('w', 'slowdown', slow_down, {repeatable=true})
...
mp.add_key_binding('e', 'speedup', speed_up, {repeatable=true})
